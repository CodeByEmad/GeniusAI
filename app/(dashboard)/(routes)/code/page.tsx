        ...
        <div>
          <Form {...form}>
            <form
              ...
              className="rounded-lg border w-full p-4 px-3 md:px-6 focus-within:shadow-sm grid grid-cols-12 gap-2   text-black"
            >
              <FormField
                name="prompt"
                render={({ field }) => (
            ...
            {messages.map((message, index) => (
              <div
                ...
                className={cn(
                  ...
                  message.role === "user" ? "bg-white border text-black border-black/10" : "bg-muted text-black"
                )}
              >
